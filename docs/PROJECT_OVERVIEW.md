...
Build an AI tutor that guides students through math problems using Socratic questioning (like the OpenAI x Khan Academy demo: [https://www.youtube.com/watch?v=IvXZCocyU\_M](https://www.youtube.com/watch?v=IvXZCocyU_M)). System accepts problems via screenshot or text and helps students discover solutions through guided dialogue.
